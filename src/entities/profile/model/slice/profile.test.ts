import { profileReducer, updateProfileData } from 'entities/profile';
...
import { cancelEdit, setReadonly, updateProfile } from './profile';
...
describe('profileSlice', () => {
  test('test set readonly', () => {
    ...
    expect(profileReducer(state as ProfileSchema, setReadonly(true))).toEqual({
      readonly: true,
    });
  });
